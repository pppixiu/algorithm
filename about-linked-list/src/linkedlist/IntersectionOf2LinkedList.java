 ...
 * they might be cycle or not
 * find the intersection of them
 * return null if no intersection
 *
 * @Classname IntersectionOf2LinkList
 * @Description non
...
public class IntersectionOf2LinkedList {
    ...
    public static Node getIntersection(Node head1, Node head2) {
        ...
        if (loop1 == null && loop2 == null) {
            return findIntersectionWithNoLoop(head1, head2);
        }
    ...
    public static Node findIntersectionWithNoLoop(Node head1, Node head2) {
        if (head1 == null || head2 == null) {
            return null;
        }
